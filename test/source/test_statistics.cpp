...
BOOST_AUTO_TEST_CASE(HypothesisTestingKS) {
    ...
    auto [ks_stat, p_value] = liarsdice::statistics::HypothesisTest::kolmogorov_smirnov_test(data, normal);
...
BOOST_AUTO_TEST_CASE(ChiSquareTest) {
    ...
    auto [chi_square, df] = liarsdice::statistics::HypothesisTest::chi_square_test(observed, expected);
