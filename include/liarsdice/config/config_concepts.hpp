 ...
 */
template<typename T, typename ValueType>
concept ConfigSerializer = requires(const T& serializer, const ValueType& value, const std::string& str) {
 ...
 */
template<typename T, typename ValueType>
concept ConfigChangeListener = requires(T& listener, const std::string& key, const ValueType& old_val, const ValueType& new_val) {
