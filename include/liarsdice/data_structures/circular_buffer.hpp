...
public:
    ...
    [[nodiscard]] auto calculate_statistics(Extractor extractor) const 
    ...
    [[nodiscard]] std::vector<size_type> find_patterns(
        size_type pattern_size, Predicate predicate) const {
