...
public:
     ...
     */
    DatabaseResult<boost::filesystem::path> compress_backup(const boost::filesystem::path& backup_file);
    
    /**
     * @brief Decompress backup file
     */
    DatabaseResult<boost::filesystem::path> decompress_backup(const boost::filesystem::path& compressed_file);
