...
#define GAME_LOG_TRACE(msg, ...) LOG_TRACE(*liarsdice::logging::get_game_logger(), msg __VA_OPT__(,) __VA_ARGS__)
#define GAME_LOG_DEBUG(msg, ...) LOG_DEBUG(*liarsdice::logging::get_game_logger(), msg __VA_OPT__(,) __VA_ARGS__)
#define GAME_LOG_INFO(msg, ...) LOG_INFO(*liarsdice::logging::get_game_logger(), msg __VA_OPT__(,) __VA_ARGS__)
#define GAME_LOG_WARN(msg, ...) LOG_WARN(*liarsdice::logging::get_game_logger(), msg __VA_OPT__(,) __VA_ARGS__)
#define GAME_LOG_ERROR(msg, ...) LOG_ERROR(*liarsdice::logging::get_game_logger(), msg __VA_OPT__(,) __VA_ARGS__)

// Dice-specific logging macros
#define DICE_LOG_TRACE(msg, ...) LOG_TRACE(*liarsdice::logging::get_dice_logger(), msg __VA_OPT__(,) __VA_ARGS__)
#define DICE_LOG_DEBUG(msg, ...) LOG_DEBUG(*liarsdice::logging::get_dice_logger(), msg __VA_OPT__(,) __VA_ARGS__)
#define DICE_LOG_INFO(msg, ...) LOG_INFO(*liarsdice::logging::get_dice_logger(), msg __VA_OPT__(,) __VA_ARGS__)

// Player-specific logging macros
#define PLAYER_LOG_TRACE(msg, ...) LOG_TRACE(*liarsdice::logging::get_player_logger(), msg __VA_OPT__(,) __VA_ARGS__)
#define PLAYER_LOG_DEBUG(msg, ...) LOG_DEBUG(*liarsdice::logging::get_player_logger(), msg __VA_OPT__(,) __VA_ARGS__)
#define PLAYER_LOG_INFO(msg, ...) LOG_INFO(*liarsdice::logging::get_player_logger(), msg __VA_OPT__(,) __VA_ARGS__)

// Performance logging macros
#define PERF_LOG_INFO(msg, ...) LOG_INFO(*liarsdice::logging::get_performance_logger(), msg __VA_OPT__(,) __VA_ARGS__)
#define PERF_TIMER(operation) LOG_SCOPED_TIMER(*liarsdice::logging::get_performance_logger(), operation)
...
#define DICE_LOG_TRACE(msg, ...) do {} while(0)
#define DICE_LOG_DEBUG(msg, ...) do {} while(0)
#define DICE_LOG_INFO(msg, ...) do {} while(0)

#define PLAYER_LOG_TRACE(msg, ...) do {} while(0)
#define PLAYER_LOG_DEBUG(msg, ...) do {} while(0)
#define PLAYER_LOG_INFO(msg, ...) do {} while(0)

#define PERF_LOG_INFO(msg, ...) do {} while(0)
#define PERF_TIMER(operation) do {} while(0)

#define WITH_CORRELATION_ID(logger, id) do {} while(0)
