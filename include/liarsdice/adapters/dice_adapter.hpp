...
public:
   ...
   */
  explicit DiceAdapter(std::unique_ptr<interfaces::IRandomGenerator> rng) : rng_(std::move(rng)) {}
  ...
  bool is_valid_face_value(unsigned int value) const override { return value >= 1 && value <= 6; }
