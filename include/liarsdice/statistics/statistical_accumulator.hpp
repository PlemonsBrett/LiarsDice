...
public:
    ...
    using rolling_accumulator_set = acc::accumulator_set<T,
        acc::stats<
    ...
    StatisticalAccumulator() 
        : rolling_acc_(acc::tag::rolling_window::window_size = WindowSize) {}
     ...
     */
    [[nodiscard]] T skewness() const {
        return acc::skewness(acc_);
    }
     ...
     */
    [[nodiscard]] T kurtosis() const {
        return acc::kurtosis(acc_);
    }
     ...
     */
    template<int N>
    [[nodiscard]] T moment() const {
        return acc::moment<N>(acc_);
    }
     ...
     */
    [[nodiscard]] T rolling_mean() const {
        return acc::rolling_mean(rolling_acc_);
    }
     ...
     */
    [[nodiscard]] T rolling_variance() const {
        return acc::rolling_variance(rolling_acc_);
    }
     ...
     */
    [[nodiscard]] T rolling_std_dev() const {
        return std::sqrt(rolling_variance());
    }
    ...
    void reset() {
        ...
        rolling_acc_ = rolling_accumulator_set(
