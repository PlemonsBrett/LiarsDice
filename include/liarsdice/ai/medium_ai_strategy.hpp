...
namespace liarsdice::ai {
  ...
  protected:
     ...
     */
    [[nodiscard]] double calculate_bayesian_probability(const core::Guess& guess,
     ...
     */
    void update_opponent_model(unsigned int player_id, const core::Guess& guess, bool was_bluff);

    /**
     * @brief Detect bluff patterns in opponent behavior
     */
    [[nodiscard]] double detect_bluff_probability(const core::Guess& guess) const;
