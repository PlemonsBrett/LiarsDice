...
namespace liarsdice::ai {
  ...
  protected:
    ...
    [[nodiscard]] core::Guess generate_safe_guess(
        const std::optional<core::Guess>& last_guess) const;
    [[nodiscard]] core::Guess generate_bluff_guess(
        const std::optional<core::Guess>& last_guess) const;
  ...
  private:
    ...
    [[nodiscard]] double calculate_adjusted_probability(const core::Guess& guess,
