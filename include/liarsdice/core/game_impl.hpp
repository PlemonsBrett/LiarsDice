...
public:
   ...
   */
  explicit GameImpl(std::unique_ptr<interfaces::IGameState> game_state,
...
private:
  ...
  validate_guess_rules(const interfaces::Guess &new_guess,
                       const std::optional<interfaces::Guess> &last_guess) const;
