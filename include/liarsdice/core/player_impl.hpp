...
public:
   ...
   */
  explicit PlayerImpl(int player_id, std::unique_ptr<interfaces::IRandomGenerator> random_generator,
  ...
  [[nodiscard]] std::vector<std::reference_wrapper<const interfaces::IDice>>
  get_dice() const override;
