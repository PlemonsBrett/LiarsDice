...
MediumAIStrategy::MediumAIStrategy(unsigned int id)
    : MediumAIStrategy(id, MediumConfig{}) {}
...
void MediumAIStrategy::update_opponent_model(
...
core::Guess MediumAIStrategy::generate_strategic_guess(
    ...
    if (cache_valid_) {
        ...
        for (unsigned int face = 1; face <= 6; ++face) {
            ...
            double expected_others = cached_face_probabilities_[face-1] * 
                                   (10 - my_dice.size()); // Estimate other dice
