...
TEST_CASE("Register and resolve transient service", "[service-container]") {
  ...
  // Register service
  container->register_service<ITestService, TestServiceImpl>(ServiceLifetime::kTransient, "", 100);
...
TEST_CASE("Register and resolve singleton service", "[service-container]") {
  auto container = std::make_unique<ServiceContainer>();
  // Register singleton
  container->register_service<ITestService, TestServiceImpl>(ServiceLifetime::kSingleton, "", 200);
...
TEST_CASE("Register named service", "[service-container]") {
  ...
  container->register_service<ITestService, TestServiceImpl>(ServiceLifetime::kTransient,
                                                             "service1", 111);
  container->register_service<ITestService, TestServiceImpl>(ServiceLifetime::kTransient,
                                                             "service2", 222);
...
TEST_CASE("Get registered services", "[service-container]") {
  ...
  container->register_service<ITestService, TestServiceImpl>(ServiceLifetime::kTransient,
                                                             "service1");
  container->register_service<ICalculator, Calculator>(ServiceLifetime::kTransient, "calc");
